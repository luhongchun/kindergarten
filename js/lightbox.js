	...
	Lightbox = (function() {
		...
		Lightbox.prototype.changeImage = function(imageNumber) {
			...
			preloader.onload = function() {
				...
				var newSize = resizeImage(preloader);
				preloader.width = newSize[0];
				preloader.height = newSize[1];
		...
		Lightbox.prototype.sizeContainer = function(imageWidth, imageHeight) {
			...
			setTimeout(function() {
				...
				$lightbox.find('.lb-image').width(imageWidth).height(imageHeight);
				_this.showImage();
		...
		function resizeImage(preloader) {
			...
			arrayNewImageSize = new Array(imageWidth, imageHeight);
